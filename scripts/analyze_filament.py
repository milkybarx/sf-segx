...
def main() -> None:
    ...
    parser.add_argument("--model", default="mask2former", choices=["mask2former"])
    ...
    result = run_phase2_analysis(image, image_id=args.image.stem, threshold=args.threshold,
                                 min_area=args.min_area, output_dir=args.output)
    print(f"Mask2Former detected {len(result['filaments'])} filament(s)")
